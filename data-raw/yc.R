...
devtools::use_data(yctc_startups, overwrite = TRUE)
devtools::use_data(yctc_person, overwrite = TRUE)
devtools::use_data(yctc_founders, overwrite = TRUE)
devtools::use_data(yctc_education, overwrite = TRUE)
devtools::use_data(yctc_title, overwrite = TRUE)
devtools::use_data(yctc_experience, overwrite = TRUE)
devtools::use_data(yctc_degree, overwrite = TRUE)
devtools::use_data(yctc_major, overwrite = TRUE)
